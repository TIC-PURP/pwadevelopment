...
export default function DictamenesPage() {
  ...
  const dictamenesProductor = dictamenes.filter(
    (d) => d.productorId === productorId
  );
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex items-center justify-center h-64">
          <p className="text-gray-600 dark:text-gray-400">
            El productor no fue encontrado
          </p>
        </div>
      </div>
    );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  CC: {productor.cedula} • {dictamenesProductor.length}{" "}
                  dictámenes técnicos
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-2">
                        <div className="flex items-center gap-3">
                          <h4 className="font-semibold text-gray-900 dark:text-white">
                            Ciclo: {dictamen.ciclo}
                          </h4>
                          <Badge className={getStatusColor(dictamen.status)}>
                            <span className="mr-1">
                              {getStatusIcon(dictamen.status)}
                            </span>
                            {dictamen.status}
                          </Badge>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              {new Date(dictamen.fecha).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="flex gap-2">
                        <Link
                          href={`/productores/${productorId}/dictamen/${dictamen.id}/ver`}
                        >
                        ...
                        <Link
                          href={`/productores/${productorId}/dictamen/${dictamen.id}/editar`}
                        >
